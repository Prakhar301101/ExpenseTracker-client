...
const Home = () => {
  return (
    <div className='min-h-screen flex flex-col'>
      <Header />
        <div className=" font-Roboto py-8 px-4 my-auto flex flex-col justify-around sm:items-center lg:flex-row ">
          <div className="w-full lg:w-2/4 p-4">
            <h1 className="text-3xl text-center md:text-start md:text-4xl py-4 lg:text-5xl font-bold">
              Welcome to Expense Master Your Ultimate Financial Companion
            </h1>
            <p className="text-lg text-center md:text-start lg:text-xl py-4">
            ...
            <h1 className="text-xl lg:text-2xl py-4 text-center md:text-start ">
